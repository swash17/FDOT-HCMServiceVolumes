...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
	...
	<table border="0" width="100%">
	  <tr>
		<td width="15%" align="left" colspan="1"><b><font size="3">TABLE1</font></b></td>
		<td width="75%" align="center" colspan="1"><font size="3"><b>Freeway Service Volumes for Florida</b> <!--Volumes for Florida's<br><b>Rural Undeveloped Areas and Cities</b> OR
      <b>Developed Areas Less than 5,000 Population</b><sup>1</sup></br>-->
	  </font>
	  </td>
		<td width="10%" align="right" colspan="1"><font size="2">DRAFT 03/02/2021</font></td>
	 </tr>
	</table>
...
<!-- C2RuralUndeveloped starts-->
				  ...
				  <TABLE width="100%" cellpadding="0" cellspacing="0" border="0" align="center" >
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C2RuralUndeveloped']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='4']/SERVICEVOL">
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C2RuralUndeveloped']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='6']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C2RuralUndeveloped']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='8']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
...
<!-- C4-UrbanGeneral starts -->
				 ...
				 <TABLE width="100%" cellpadding="0" cellspacing="0" border="0" align="center" >
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C4UrbanGeneral']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='4']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C4UrbanGeneral']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='6']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C4UrbanGeneral']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='8']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
...
<!-- C5UrbanCenter starts -->
					...
					<TABLE width="100%" cellpadding="0" cellspacing="0" border="0" align="center" >
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C5UrbanCenter']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='4']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C5UrbanCenter']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='6']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C5UrbanCenter']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='8']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
...
<!-- C3R/C3C - Suburban starts -->
				 ...
				 <TABLE width="100%" cellpadding="0" cellspacing="0" border="0" align="center" >
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C3R/C3C - Suburban']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='4']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C3R/C3C - Suburban']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='6']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
					  ...
					  <tr>
						  ...
						  <xsl:for-each select="TMML/FREEWAY[@AreaType='C3R/C3C - Suburban']/LOSTABLES[@Mode='Auto']/CROSSSECTION[@Lanes='8']/SERVICEVOL">
							  <td width="15%" align="center">
								  <font size="2">
									  <xsl:value-of select="PeakDirection"/>
								  </font>
					 ...
					 <tr>
						  <p>
							  <font size="1">
									  ...
									  The setvice volume values shown are presented as peak hour directional, peak hour bi-directional, and annual average daily volumes for freeway, levels of service and are for the automobile/truck modes unless specifically stated.
