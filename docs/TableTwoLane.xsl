...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
	...
	<table border="0" width="100%">
	  <tr>
		<td width="15%" align="left" colspan="1"><b><font size="3">TABLE3</font></b></td>
		<td width="75%" align="center" colspan="1"><font size="3"><b>Two-Lane Highway Service Volumes for Florida</b> <!--Volumes for Florida's<br><b>Rural Undeveloped Areas and Cities</b> OR
